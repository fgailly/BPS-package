...
#'
#' Due to the technical implementation of the simmer-package, the dataframe received by the get_mon_arrivals()-function
#' of the simmer-package should be transformed to have the correct activity time when using AND-gates.
#'
