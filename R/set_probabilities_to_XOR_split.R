...
#' In the case of a XOR-GATE structure, this function can be used to specify the probability to flow through one of the alternative paths by using the parameters first_activities and probabilities.
...
#' @param first_activities a character vector containing the name of the first element of each alternative path of the XOR-GATE structure.
#' @param probabilities a numeric vector containing the probability of flowing through each alternative path.the sum should be equal to 1. The sequence of the branches should be identical to the sequence in the first_activities vector
