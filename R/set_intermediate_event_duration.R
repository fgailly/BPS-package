...
#' @param inter_event The intermediate_event of which the duration will be set. Accepts a list object created with the add_intermediate_event function OR with the import_BPMN function
